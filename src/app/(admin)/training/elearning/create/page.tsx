...
export default function CreateElearningModulePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setLoading(true);
            await TrainingService.createElearningModule({
                ...formData,
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                ...
                <h1 className="text-2xl font-bold">Ajouter un module E-Learning</h1>
            </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="col-span-2">
                            ...
                            <textarea
                                ...
                                placeholder="Markdown ou notes additionnelles..."
                            />
                        </div>
                    </div>
