        ...
        <ComponentCard title="Actions Rapides">
          <div className="flex flex-wrap gap-4">
            ...
            <Link 
              ...
              className="inline-flex items-center justify-center rounded-md bg-purple-600 px-10 py-4 text-center font-medium text-white hover:bg-purple-700 transition-colors lg:px-8 xl:px-10"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
